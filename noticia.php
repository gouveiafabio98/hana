...
<body>
    ...
    <main id="istonaoeoindex">
		...
		V99.46C232.167,96.972,230.157,94.978,227.675,94.978z" />
                ...
                <li>
                    <span><a href="noticias" class="link">Notícias</a> /</span>
                </li>
                <li>
                    <span><a href="noticia?new=" id="activated">titulo</a> </span>
                </li>
            </ul>
        </div>
        ...
        <div class="title">
            <div>
                <span class="name">Livro não encontrado</span>
            </div>
            <span id="nota">Data não encontrada</span>
        </div>

        <div>
            <article>
                <h3 id="subtitulo">Subtitulo não encontrado</h3>
            </article>
        </div>
